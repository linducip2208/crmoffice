...
<body class="font-sans bg-slate-950 text-white antialiased flex flex-col min-h-screen">
    ...
    <main class="relative flex-1 flex items-center justify-center px-5 overflow-hidden">
        ...
        <div class="relative text-center max-w-2xl py-12">
            <div class="text-7xl md:text-8xl mb-6">&#9888;&#65039;</div>
            <div class="inline-flex items-center gap-2 text-xs font-bold tracking-wider uppercase text-brand-200 bg-white/5 border border-white/10 rounded-full px-3 py-1.5 mb-8">Error &middot; 500</div>
            <h1 class="text-5xl md:text-6xl font-extrabold leading-tight tracking-tight mb-4">Kesalahan Server</h1>
            <p class="text-slate-300 text-base md:text-lg leading-relaxed max-w-md mx-auto">Sesuatu rusak di server kami. Tim teknis sudah mendapat notifikasi. Coba refresh dalam beberapa menit.</p>

...
<body class="font-sans bg-slate-950 text-white antialiased flex flex-col min-h-screen">
    ...
    <main class="relative flex-1 flex items-center justify-center px-5 overflow-hidden">
        ...
        <div class="relative text-center max-w-2xl py-12">
            ...
            <div class="inline-flex items-center gap-2 text-xs font-bold tracking-wider uppercase text-brand-200 bg-white/5 border border-white/10 rounded-full px-3 py-1.5 mb-8">Info &middot; 503</div>
            <h1 class="text-5xl md:text-6xl font-extrabold leading-tight tracking-tight mb-4">Dalam Pemeliharaan</h1>
            <p class="text-slate-300 text-base md:text-lg leading-relaxed max-w-md mx-auto">Aplikasi sedang di-upgrade. Biasanya selesai dalam 5&ndash;10 menit. Silakan kembali sebentar lagi.</p>
